...
<style>
  body { font-family: Arial, sans-serif; background-color: #d1d5db; display: flex; justify-content: center; padding: 20px; }
  .container { background: #e5e7eb; padding: 24px; border-radius: 16px; max-width: 400px; width: 100%; box-shadow: 0 4px 6px rgba(0,0,0,0.1); border: 1px solid black; }
  ...
  .enquire-button { background-color: #4181ff; color: #ffffff; padding: 12px; border-radius: 6px; text-align: center; display: block; margin: 16px auto 0; text-decoration: none; font-weight: bold; cursor: pointer; }
</style>
</head>
<body>
<div class="container">
